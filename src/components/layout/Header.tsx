      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <Link href="/" className="flex items-center gap-0.5">
            <span className="text-xl font-extrabold text-emerald-600 tracking-tight">Pre</span>
            <span className="text-xl font-extrabold text-gray-900 tracking-tight">Padel</span>
          </Link>
