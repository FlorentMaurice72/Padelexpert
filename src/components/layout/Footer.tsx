    ...
    <footer className="bg-gray-900 text-gray-400 mt-20">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <p className="text-white font-bold text-lg mb-2">
              <span className="text-emerald-400">Padel</span>Expert
            </p>
            <p className="text-sm">
              Le guide de référence pour les joueurs de padel débutants. Conseils, tests et comparatifs honnêtes.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/comparatifs" className="hover:text-white transition-colors">Comparatifs</Link></li>
        ...
        <div className="border-t border-gray-800 mt-10 pt-6 text-xs text-center space-y-1">
          <p>© {new Date().getFullYear()} PadelExpert. Tous droits réservés.</p>
          <p>
